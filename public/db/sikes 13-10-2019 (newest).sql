...
-- Dumping data for table sikes.message_sent: ~11 rows (approximately)
...
-- Dumping data for table sikes.sync_tarif: ~42 rows (approximately)
...
INSERT INTO `tarif_nilai` (`tarif_nilai_id`, `ta_id`, `kelas`, `tarif_tipe_id`, `nominal`, `nominal_min`, `date_started`, `date_ended`, `active`) VALUES
	...
	(20, 3, 2, 1, 7000000, NULL, '2019-07-10', '2019-11-10', 0),
	(21, 3, 1, 1, 7000000, NULL, '2019-07-10', '2019-12-10', 0),
...
-- Dumping data for table sikes.t_pembayaran: ~44 rows (approximately)
...
-- Dumping data for table sikes.t_pembayaran_detail: ~6 rows (approximately)
