...
INSERT INTO `message_sent` (`message_sent_id`, `t_pembayaran_detail_id`, `siswa_id`, `no_ortu`, `message_type`, `message_text`, `nominal`, `date_added`, `date_modified`, `created_by`, `active`) VALUES
	(2, 2, 9, '6287820988075', 'pembayaran', 'Pembayaran untuk SPP Bulanan bulan ke 11 yang dilakukan oleh siswa bernama M Cholis Malik(13114) sebesar Rp 5,000,000 telah kami terima', '5000000', '2019-11-07 20:41:03', '2019-11-07 20:41:03', 1, 1),
	(4, 3, 9, '6287820988075', 'pembayaran', 'Pembayaran untuk SPP Bulanan bulan ke 12 yang dilakukan oleh siswa bernama M Cholis Malik(13114) sebesar Rp 5,000,000 telah kami terima', '5000000', '2019-11-14 22:10:32', '2019-11-14 22:10:32', 1, 1),
	(5, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp 5000000, untuk tahun 2019, bulan ke 11, kelas 2', NULL, '2019-11-14 22:13:00', '2019-11-14 22:13:00', NULL, 1),
	(6, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp 5000000, untuk tahun 2019, bulan ke 11, kelas 2', NULL, '2019-11-14 22:16:46', '2019-11-14 22:16:46', NULL, 1),
	(7, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp 5000000, untuk tahun 2019, bulan ke 11, kelas 2', '5000000', '2019-11-14 22:17:08', '2019-11-14 22:17:08', NULL, 1),
	(8, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp IDR 5,000,000.00, untuk tahun 2019, bulan ke 11, kelas 2', 'IDR 5,000,000.00', '2019-11-14 22:20:52', '2019-11-14 22:20:52', NULL, 1),
	(9, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp undefined, untuk tahun 2019, bulan ke 11, kelas 2', NULL, '2019-11-14 22:22:54', '2019-11-14 22:22:54', NULL, 1),
	(10, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp undefined, untuk tahun 2019, bulan ke 11, kelas 2', NULL, '2019-11-14 22:23:09', '2019-11-14 22:23:09', NULL, 1),
	(11, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp IDR 5,000,000.00, untuk tahun 2019, bulan ke 11, kelas 2', 'IDR 5,000,000.00', '2019-11-14 22:23:16', '2019-11-14 22:23:16', NULL, 1),
	(12, NULL, 11, '6287820988075', 'reminder', 'Diharapkan untuk siswa bernama Helmi Fauzi (13115) segera membayarkan tunggakan SPP Bulanan sebesar  Rp 5000000, untuk tahun 2019, bulan ke 11, kelas 2', '5000000', '2019-11-14 22:23:56', '2019-11-14 22:23:56', NULL, 1);
...
-- Dumping data for table sikes.tarif_nilai: ~0 rows (approximately)
...
INSERT INTO `tarif_nilai` (`tarif_nilai_id`, `ta_id`, `kelas`, `tarif_tipe_id`, `nominal`, `nominal_min`, `date_started`, `date_ended`, `active`) VALUES
	...
	(36, 2, 2, 1, 200000, NULL, '2019-11-10', '2019-11-10', 0);
...
INSERT INTO `t_jurnal` (`t_jurnal_id`, `tarif_tipe_id`, `tarif_nilai_id`, `jurnal_type`, `total`, `keterangan`, `active`, `date_added`, `date_modified`) VALUES
	(2, 0, 0, 'out', 900000, 'APasss', 1, '2019-11-08', NULL),
	(3, 1, 35, 'in', 5000000, '(13114) M Cholis Malik membayar SPP Bulanan untuk ta 2019 kelas 2 bulan ke 11', 1, '2019-11-07', NULL),
	(4, 1, 35, 'in', 5000000, '(13114) M Cholis Malik membayar SPP Bulanan untuk ta 2019 kelas 2 bulan ke 12', 1, '2019-11-14', NULL);
...
INSERT INTO `t_pembayaran` (`t_pembayaran_id`, `siswa_id`, `tarif_nilai_id`, `tahun`, `bulan_ke`, `nominal`, `nominal_min`, `nominal_bayar`, `date_added`, `date_modified`, `created_by`) VALUES
	...
	(84, 9, 35, 2019, 12, 5000000, NULL, 5000000, '2019-11-06 14:33:36', '2019-11-06 14:33:36', 1),
...
INSERT INTO `t_pembayaran_detail` (`t_pembayaran_detail_id`, `t_pembayaran_id`, `nominal`, `date_added`, `created_by`) VALUES
	...
	(3, 84, 5000000, '2019-11-14 22:10:31', 1);
...
CREATE TABLE `v_message_sent` (
	...
	`nominal` VARCHAR(20) NULL COLLATE 'latin1_swedish_ci',
...
LEFT JOIN tarif_nilai tn ON tn.tarif_nilai_id = tp.tarif_nilai_id AND tn.active = 1
LEFT JOIN ta ON ta.ta_id = tn.ta_id AND ta.active = 1
LEFT JOIN tarif_tipe tt ON tt.tarif_tipe_id = tn.tarif_tipe_id AND tt.active = 1
WHERE ms.active = 1 ;
