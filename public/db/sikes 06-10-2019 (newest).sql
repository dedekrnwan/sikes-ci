...
-- Dumping data for table sikes.role: ~1 rows (approximately)
...
-- Dumping data for table sikes.sync_tarif: ~10 rows (approximately)
...
INSERT INTO `sync_tarif` (`sync_tarif_id`, `siswa_id`, `tarif_nilai_id`, `tahun`, `bulan_ke`, `status`, `date_added`, `created_by`) VALUES
	(342, 9, 27, NULL, NULL, 1, '2019-11-06 12:52:20', 1);
...
-- Dumping data for table sikes.tarif_nilai: ~8 rows (approximately)
...
INSERT INTO `tarif_nilai` (`tarif_nilai_id`, `ta_id`, `kelas`, `tarif_tipe_id`, `nominal`, `nominal_min`, `date_started`, `date_ended`, `active`) VALUES
	(19, 3, 1, 1, 30000000, NULL, '2019-08-10', '2019-12-10', 0),
	(20, 3, 2, 1, 7000000, NULL, '2019-07-10', '2019-11-10', 1),
	(21, 3, 1, 1, 7000000, NULL, '2019-07-10', '2019-12-10', 1),
	(22, 3, 2, 1, 7000000, NULL, '2019-07-10', '2019-12-10', 0),
	(23, 3, 2, 1, 8000000, NULL, '2019-07-10', '2019-12-10', 0),
	(24, 3, 2, 3, 10000000, 2000000, NULL, NULL, 1),
	(25, 3, 2, 4, 500000, NULL, '2019-11-10', '2020-04-10', 1),
	(26, 3, 1, 4, 200000, NULL, '2019-11-10', '2020-02-10', 1),
	(27, 3, 2, 5, 800000, 200000, NULL, NULL, 1);
...
-- Dumping data for table sikes.tarif_tipe_spesific: ~4 rows (approximately)
/*!40000 ALTER TABLE `tarif_tipe_spesific` DISABLE KEYS */;
INSERT INTO `tarif_tipe_spesific` (`tarif_tipe_spesific_id`, `tarif_tipe_id`, `siswa_id`, `active`) VALUES
	(4, 4, 9, 0),
	(11, 4, 9, 1),
	(12, 5, 9, 1),
	(6, 4, 10, 0),
...
-- Dumping data for table sikes.t_jurnal: ~0 rows (approximately)
...
INSERT INTO `t_pembayaran` (`t_pembayaran_id`, `siswa_id`, `tarif_nilai_id`, `tahun`, `bulan_ke`, `nominal`, `nominal_min`, `nominal_bayar`, `date_added`, `date_modified`, `created_by`) VALUES
	(53, 9, 27, 0, 0, 800000, 200000, 0, '2019-11-06 12:52:20', '2019-11-06 12:52:20', 1);
